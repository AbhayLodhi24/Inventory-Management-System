...
public interface OrdersRepository extends JpaRepository<Orders, Integer> {
	...
	@Query(
			value = "SELECT * FROM (" +
					...
					"   SELECT o.order_id, o.order_date, o.product_name, o.category_name, u.username, u.address, o.quantity, o.total_price " +
					"   FROM orders o " +
					...
					") WHERE rnum > :startRow",
			nativeQuery = true)
	List<Object[]> searchOrdersNative(
	...
	@Query(
			value = "SELECT COUNT(*) FROM orders o " +
					...
					"  TO_CHAR(o.total_price) LIKE '%' || :searchTerm || '%'",
			nativeQuery = true)
	long countOrdersNative(@Param("searchTerm") String searchTerm);
}
