$(document).ready(function() {
    ...
    const registerTogglePasswordIcon = document.getElementById('registerTogglePassword'); // Assuming the toggle icon for register has this ID

    if (registerTogglePasswordIcon && registerPasswordInput) {
    ...
    // For the second password input (as per your second HTML snippet)
    const loginPasswordInput = document.getElementById('password');
    const loginTogglePasswordIcon = document.getElementById('loginTogglePassword'); // Assuming the toggle icon for login also has this ID

    if (loginTogglePasswordIcon && loginPasswordInput) {
        loginTogglePasswordIcon.addEventListener('click', function() {
